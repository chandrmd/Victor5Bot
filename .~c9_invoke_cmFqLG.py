...
cl = LINETCR.LINE() #Luffy-Yuyu
cl.login(token="EmWs0kG44EwbgAP1Z1X6.tnwZdM0U3cpoQ/HMLfz5PG.OgQltL4OZ1mY59KpuRC4pdzH0jjJemR1EFniaCrgHpI=")
cl.loginResult()

ki = LINETCR.LINE() #Zorro-Victor
ki.login(token="EmlOUdn44emUbSOoYGa4.s/RF9gK3O6VcaqTzUmAE1a.Q1tDRU48hKKGJrXBsokPnph5EJ9oKnbGlbrU+qzCFjU=")
ki.loginResult()
...
kc = LINETCR.LINE() #Ussop-Satria
kc.login(token="EmGrZc0WUAceDpNo6nYb.tmXRTkFa/LE8faVnZHXC2W.ipk9fB4rJmdVlvu/exDS9p+maTLcCu5LbDvQPv3i4Uo=")
kc.loginResult()

ks = LINETCR.LINE() #Chooper-Devran
ks.login(token="Em5O9nnykxcGrfwW6yr4.Tnx7hOlw4bRwrIcGKM7j1a.ksWV+KmVBwFl+cuBeicjq9uBBkj1Doeok2IvVZc8uv4=")
ks.loginResult()
...
#-----------------------------------------------
                ...
                kk.sendText(msg.to,"Kembaran pc rl 􀜁􀅔Har Har􏿿")
    ...
    for zx in range(0,500):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Tadi masa gua abis nyemplung got 􀜁�Har Har􏿿�")
