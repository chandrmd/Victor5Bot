...
cl = LINETCR.LINE() #Luffy-Devran
cl.login(token="EmziRPYLvGymTkWMbFh4.Tnx7hOlw4bRwrIcGKM7j1a.hLg66k0itg6QMd9rdwc32o1dDs5ekrfUSZgVMuFIRzc=")
cl.loginResult()

ki = LINETCR.LINE() #Zorro-Alkath
ki.login(token="EmArMyTGKONWOzQd3qge.nc7K1TQSiM6/92KU7NvoRG.KtRvFnFMRlDhTw/jP7luCdvq7cGdgr8vl+USAgOu/KQ=")
ki.loginResult()

kk = LINETCR.LINE() #Sanji-Victorc
kk.login(token="Em5m8ip2ipFWHarq3myb.tSkc15xLLIDlxT3cXPj5sW.6ksUibT39e8vqg0Xfx7AjCawtf65S07M+hjBdL0xh5E=")
kk.loginResult()

kc = LINETCR.LINE() #Ussop-Grey
kc.login(token="EmVTEdGCn3HmaGea2B37.HTJ3Ss5Qi7BCcc+BERaSnW.iV7R+hre32SyGS8UX6Uz3GhiNtKHkjS3YPPIsC7yAAc=")
kc.loginResult()

ks = LINETCR.LINE() #Chooper-Dicky
ks.login(token="EmPNIYxdaKlkjUXEhYAc.XL/L4vdcLPkOro487rJfha.PpTpaK+G7rx2635ZYyBubH9tszA9UIV3qTDN/IVYOSw=")
ks.loginResult()

print "login success yo"
reload(sys)
sys.setdefaultencoding('utf-8')

helpMessage ="""V҉I҉C҉T҉O҉R҉B҉O҉T҉ ҉T҉e҉a҉m҉ ҉P҉r҉o҉t҉e҉c҉t҉
-==================-
-Menu For Public-
-==================-
•Help/Key/Keyword
...
•Absen/Respon
•Banlist
•Gn 「nama grup yang akan diganti」
•Kick 「mid」
•Invite 「mid」
•Bot?/Ler
•Gift/All gift
•TL: 「text」
•Bot「1-3」 rename 「text」/Cn 「text」
•Mc 「mid」
•Cancel 「on/off」
•Contact 「on/off」
•Join 「on/off」
...
admin=["u4beadff46937a3abc2010b59b8c69ed4","u4ccc6bb4a7c0fa57bc140bcdce1c5cdb","u087a039ce3d732ce6244a56c5c62e3e7","u28ceff5a643e153d1990e2473e9fd722","u342ee4d6daac226ebef7692eee754eae"]
owner=["u4beadff46937a3abc2010b59b8c69ed4","u087a039ce3d732ce6244a56c5c62e3e7"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"""Thanks for added
    
≫ Victor Bot≪
Id: http://line.me/ti/p/~gipdulu""",
    "lang":"JP",
          ...
          if wait["Protectgr"] == True:
            if cl.getGroup(op.param1).preventJoinByTicket == False:
              ...
              if op.param2 in admin:
                ...
                try:
                  cl.sendText(op.param1,cl.getContact(op.param2).displayName + "Jangan Buka Kode QR Njir :)")
                  cl.kickoutFromGroup(op.param1,[op.param2])
                  X = cl.getGroup(op.param1)
                  X.preventJoinByTicket = True
                  cl.updateGroup(X)
                except:
                  random.choice(KAC).sendText(op.param1,random.choice(KAC).getContact(op.param2).displayName + "Jangan Buka Kode QR Njir :)")
...
#--------------------------------
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                ...
                return
            elif msg.text in ["Key","help","Help","Keyword"]:
                if wait["lang"] == "JP":
    ...
    #--------------- SC Add Admin ---------
              ...
              if msg.from_ in owner:
                ...
                cl.sendText(msg.to,"Hanya owner yang bisa mengguunakan perintah ini.")
              ...
              if msg.from_ in owner:
                ...
                cl.sendText(msg.to,"Perintah Ditolak.")
                cl.sendText(msg.to,"Hanya owner yang bisa menggunakan Perintah ini.")
              ...
              if msg.from_ in admin:
                ...
                if txt[1] == "on":
                    ...
                    if jmlh <= 300:
                        ...
                        cl.sendText(msg.to, "Kelebihan batas :v")
    #-----------------=Selesai=------------------
            elif msg.text in ["Bot?","Ler"]: #Ngirim Semua Kontak Bot
              if msg.from_ in admin:
                msg.contentType = 13
              ...
              if msg.from_ in admin:
                ...
                ##cl.sendMessage(msg)
            elif msg.text in ["Buka qr","Open qr","Ourl"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                ...
                cl.sendText(msg.to,"Perintah Ditolak.")
                cl.sendText(msg.to,"Hanya admin yang bisa menggunakan perintah ini.")
            ...
            elif msg.text in ["Tutup qr","Close qr","Curl"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    X = random.choice(KAC).getGroup(msg.to)
                    X.preventJoinByTicket = True
                ...
                if msg.from_ in admin:
                  ...
                  if wait["lang"] == "JP":
                    ...
                    if ginfo.preventJoinByTicket == True:
                      ...
                      QR = "Open"
                    random.choice(KAC).sendText(msg.to,"[Nama group]\n" + "[•]" + str(ginfo.name) + "\n\n[ID Group]\n" + msg.to + "\n\n[Group Creator]\n" + "[•]" + gCreator + "\n\n[Group Status]\n" + "[•]Status QR =>" + QR + "\n\n[Group Picture]\nhttp://dl.profile.line.naver.jp/" + ginfo.pictureStatus + "\n\nMembers:" + str(len(ginfo.members)) + "\nPending:" + sinvitee)
                  else:
                    random.choice(KAC).sendText(msg.to,"[Nama group]\n" + str(ginfo.name) + "\n\n[ID Group]\n" + msg.to + "\n\n[Group Creator]\n" + gCreator + "\n\n[Group Status]\nGroup Picture:\nhttp://dl.profile.line.naver.jp/" + ginfo.pictureStatus)
                else:
                  if wait["lang"] == "JP":
...
#--------===---====--------------
        ...
        #-------------Fungsi Change Clock Finish-----------------#           
         ...
         #-------------Fungsi Jam Update Start---------------------#            
            elif msg.text in ["Jam Update","Update"]:
                if wait["clock"] == True:
                    now2 = datetime.now()
                    nowT = datetime.strftime(now2,"(%H:%M)")
                    profile = kc.getProfile()
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Ketik Cctv dulu bor\nBaru ketik Ciduk ♪")
#-----------------------------------------------
...
#-----------------------------------------------
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye op","Kabur all","Kaboor all","Bye all"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
            ...
            elif msg.text in ["Kaboor","Usirr","Hushhh","Lep sono","Lep gih","Lep"]: #Semua Bot Ninggalin Group Kecuali Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
    ...
    #-------------Fungsi Tag All Finish---------------#
            elif msg.text in ["Bot Like", "Bot like","Botlike"]: #Semua Bot Ngelike Status Akun Utama
              if msg.from_ in owner:
                print "[Command]Like executed"
                cl.sendText(msg.to,"Autolike by Victor")
                try:
                  likePost()
                except:
                  pass
                
            elif msg.text in ["Like temen", "Bot like temen","Laikeu"]: #Semua Bot Ngelike Status Teman
              if msg.from_ in owner:
                print "[Command]Like executed"
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    gs = kc.getGroup(msg.to)
                    gs = ks.getGroup(msg.to)
                    random.choice(KAC).sendText(msg.to,"Grup apa ini?")
                    random.choice(KAC).sendText(msg.to,"Ratain aja lah\nRoom Ga Berguna..")
                    random.choice(KAC).sendText(msg.to,"Jangan Baper yah :v")
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': mid}
                    random.choice(KAC).sendMessage(msg)
                    targets = []
                        ...
                        for target in targets:
                          ...
                          if target in admin:
                            ...
                            try:
                              ...
                              random.choice(KAC).sendText(msg.to,"Gaada yang tangkis nih?\nWkwkwk")
                        ...
                        if targets == []:
                            ...
                            for target in targets:
                                try:
                                    ...
                                    random.choice(KAC).sendText(msg.to,"berhasil menambahkan")
                                except:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                random.choice(KAC).sendText(msg.to,"Akun telah berhasil di banned")
                            except:
                                random.choice(KAC).sendText(msg.to,"Error")
...
#-----------------------------------------------
            elif msg.text in ["Say obi tampan"]:
                ki.sendText(msg.to,"Obi tampan 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"Tampan sekali 􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"Mirip baekhyun rl 􀜁􀅔Har Har􏿿")
            elif msg.text in ["Say victor ganteng"]:
                ki.sendText(msg.to,"Victor ganteng banget 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"Kembaran pcy rl 􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"Njir 􀜁􀅔Har Har􏿿")
            elif msg.text in ["Cv say yuyu cimut","Yuyu cimut"]:
                ki.sendText(msg.to,"Yuyu cimut 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"Anak daddy pcy kw super 􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"Bah 􀜁􀅔Har Har􏿿")
            elif msg.text in ["Cv say bobo ah","Bobo dulu ah"]:
                ki.sendText(msg.to,"Have a nice dream Cv 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"Tidur yang nyenyak 􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"Jangan bangun lagi 􀜁􀅔Har Har􏿿")
            elif msg.text in ["Hai","Hi","Halo","Alo","Aloo"]:
                ki.sendText(msg.to,"Too 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"Juga pekok 􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"Juga pekok 􀜁􀅔Har Har􏿿")
            elif msg.text in ["#welcome","welkam","Welkam"]:
...
#-----------------------------------------------
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              msg.contentType = 13
              msg.contentMetadata = {'mid': 'u4beadff46937a3abc2010b59b8c69ed4'}
              cl.sendText(msg.to,"======================")
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
...
#---------------------
        ...
        if op.type == 15:
          if op.param2 in Bots:
             return
          random.choice(KAC).sendText(op.param1, "Baperan :v ")
    ...
    for zx in range(0,500):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐Victor⭐⭐👈")
          ki.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Sayang 😊")
          kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Victor ganteng 😊")
          kc.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          kc.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Obi manly :*")
          ks.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          ks.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Lb juseyo 😊")
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Yuyu cimut titik.")
          print "Like"
        except:
          pass
      else:
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto like Victor\nhtp://line.me/ti/p/~gipdulu")
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Pakabar kamu?")
                    print "Ter-Like"
                except:
                    pass
            else:
                print "Status Sudah di Like ya"
